return {
    ...
    },
    {
        ...
        config = function()
            ...
            local servers = {
                --  Add any additional override configuration in any of the following
                ...
                --
                --  Feel free to add/remove any LSPs here that you want to install via
                --  Mason. They will automatically be installed and setup.
                mason = {
            ...
            -- provided by nvim-lspconfig or define a custom server config that's
            -- unavailable on nvim-lspconfig.
